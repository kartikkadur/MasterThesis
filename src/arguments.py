...
class TrainArguments(Arguments):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--n_iters', type=int, default=1000000, help='number of train iterations')
        self.parser.add_argument('--last_iter', type=int, default=-1, help='The iteration until which the model was trained. Used while resuming training.')
        self.parser.add_argument('--max_iter', type=int, default=1000000, help='maximum number of global iterations to be performed')
        self.parser.add_argument('--n_iter_decay', type=int, default=600000, help='epoch start decay learning rate, set -1 if no decay')
