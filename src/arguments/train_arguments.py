...
class TrainArguments(Arguments):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--no_html', action='store_true', help='do not save intermediate training results to [args.checkpoints_dir]/[args.name]/web/')
        ...
        parser.add_argument('--start_epoch', type=int, default=0, help='epoch to start training with')
